                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Jadwal Kerja Non Shift</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-folder-open"></i> Jadwal Kerja Non Shift</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="padding-bottom: 50%;">
                        <div class="card">
                            <div class="card-header d-flex">
                                <h5 class="card-header-title">Jadwal Kerja Non Shift</h5>
                                <div class="toolbar ml-auto">
                                    <a href="<?php echo base_url('kepegawaian/jadwalkerja/uploadshift');?>" class="btn btn-rounded btn-brand"><i class="fas fa-plus"></i> Tambah Jadwal Kerja Non Shift</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                                $no = 0;
                                                foreach ($GetJadwalKerjaNonShift as $Get)
                                                {
                                                    $no++;
                                            ?>
                                            <tr>
                                                ...
                                                <td><?php echo $Get->StatusJamKerja;?></td>
