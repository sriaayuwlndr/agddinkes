                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Jadwal Kerja Realisasi <?= $GetPegawai['NamaLengkap'];?></h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-folder-open"></i> Jadwal Kerja Realisasi <?= $GetPegawai['NamaLengkap'];?></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header d-flex">
                                <h5 class="card-header-title">Jadwal Kerja Realisasi <?= $GetPegawai['NamaLengkap'];?></h5>
                            ...
                            <div class="card-body">
                                <form method="post" action="<?php echo base_url('agd/ekinerja/jadwalkerja/realisasi/'.$GetPegawai['IdPegawai']);?>" enctype="multipart/form-data">
                                    <div class="form-row">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered second" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                                $no = 0;
                                                foreach ($GetJadwalRealisasi as $Get)
                                                {
                                                    $no++;
                                            ?>
                                            <tr>
