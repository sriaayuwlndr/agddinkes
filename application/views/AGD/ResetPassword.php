    ...
    <div class="splash-container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo base_url('agd/lupapassword/resetpassword')?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <input class="form-control form-control-lg" type="text" name="IdPegawai" placeholder="Username" autocomplete="off" disabled="" value="<?= $IdPegawai;?>">
                    </div>
                    <div class="form-group">
                        <input class="form-control form-control-lg <?php echo form_error('Password') ? 'is-invalid':'' ?>" type="password" name="Password" placeholder="Password" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <input class="form-control form-control-lg <?php echo form_error('PasswordConfirm') ? 'is-invalid':'' ?>" type="password" name="PasswordConfirm" placeholder="Password Confirm" autocomplete="off">
                    </div>
                    <div class="form-group pt-2">
                        <button class="btn btn-block btn-primary" type="submit">Simpan Password</button>
                    </div>
                </form>
            </div>
