                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Tambah Master Pendidikan Formal</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="<?=base_url('agd/kepegawaian/masterpendidikanformal');?>" class="breadcrumb-link"><i class="fas fa-folder"></i> Master Pendidikan Formal</a></li>
                                        <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-folder-open"></i> Tambah Master Pendidikan Formal</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header d-flex">
                                <h5 class="card-header-title">Tambah Master Pendidikan Formal</h5>
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="<?php echo base_url('agd/kepegawaian/masterpendidikanformal/add');?>" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Pendidikan Formal*</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" name="PendidikanFormal" placeholder="Ketik Disini" class="form-control <?php echo form_error('PendidikanFormal') ? 'is-invalid':'' ?>">
