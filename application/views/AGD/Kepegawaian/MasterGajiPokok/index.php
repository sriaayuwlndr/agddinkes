                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Master Gaji Pokok (Tanpa Tunjangan Keluarga)</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-folder-open"></i> Master Gaji Pokok</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header d-flex">
                                <h5 class="card-header-title">Master Gaji Pokok</h5>
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                                $no = 0;
                                                foreach ($GetMasterGajiPokok as $Get)
                                                {
                                                    $no++;
                                            ?>
                                            <tr>
                                                ...
                                                <td style="width: 10%;">
                                                    <a href="<?= base_url('agd/kepegawaian/mastergajipokok/edit/'.$Get->IdPendidikanFormal&$Get->IdMasaKerja&$Get->IdPTKP);?>" class="btn btn-rounded btn-info btn-xs"><i class="fas fa-edit"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                            <?php } ?>
