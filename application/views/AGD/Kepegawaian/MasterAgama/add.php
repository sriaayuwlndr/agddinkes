                        ...
                        <div class="page-header">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="<?=base_url('agd/kepegawaian/masteragama');?>" class="breadcrumb-link"><i class="fas fa-folder"></i> Master Agama</a></li>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="<?php echo base_url('agd/kepegawaian/masteragama/add');?>" enctype="multipart/form-data">
