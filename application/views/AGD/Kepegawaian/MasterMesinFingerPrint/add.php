                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Tambah Master PTKP</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="<?=base_url('agd/kepegawaian/masterptkp');?>" class="breadcrumb-link"><i class="fas fa-folder"></i> Master PTKP</a></li>
                                        <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-folder-open"></i> Tambah Master PTKP</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header d-flex">
                                <h5 class="card-header-title">Tambah Master PTKP</h5>
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="<?php echo base_url('agd/kepegawaian/masterptkp/add');?>" enctype="multipart/form-data">
