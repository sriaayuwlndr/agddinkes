                        ...
                        <div class="card">
                            <div class="card-header d-flex">
                                ...
                                <div class="toolbar ml-auto">
                                    <a href="<?php echo base_url('agd/kepegawaian/masterjabatan/add');?>" class="btn btn-rounded btn-brand"><i class="fas fa-plus"></i> Tambah Data</a>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $Get->Pengkali; ?></td>
                                                <td><?= $Get->Grading; ?></td>
                                                <td><?= $Get->StatusAktifJabatan;?></td>
                                                <td><?= date('d M Y H:i:s',strtotime($Get->TanggalDibuat));?></td>
                                                <td style="width: 10%;">
                                                    <a href="<?= base_url('agd/kepegawaian/masterjabatan/edit/'.$Get->IdJabatan);?>" class="btn btn-rounded btn-info btn-xs"><i class="fas fa-edit"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                            <?php } ?>
